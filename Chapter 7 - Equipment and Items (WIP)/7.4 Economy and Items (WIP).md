...
> **Legend:** C/S/G/P/N are the coin types. “Use” gives precise mechanics. If an item has **material variants**, use the _Material Multipliers_ at the end of each section or the **Material MU costs** (from §7.4.6) for exact quotes.
