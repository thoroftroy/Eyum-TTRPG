...
> If you still need to create your character then see [[3.1 Building Your Character]].
...
Everyone rolls 1d20 + initiative bonus to set turn order. For more on initiative see [[1.4 Actions#Turn-Order-and-Initiative]]. The GM tracks who goes when.
#### Step 2: Your Turn
...
- **Take an Action** (attack, [[6.1 Spells|cast a spell]], dash, etc.)
- **Take a Bonus Action** (if available)
- **Use Free Actions** (talk, drop items, simple interactions)

> For more information on actions, bonus actions, and reactions see [[1.4 Actions]].
...
- You: “I roll **14**.”
- On your turn: move 10 ft, attack with your axe (roll d20 + STR + attack bonus, see [[1.2 Dice and Skills#Attack-Rolls]]), roll damage, end turn.
...
You can:
- Buy and sell items (see [[2.5 Weapons, Armors, and Tools]] and [[2.6 Materials#Money]])
- Take on quests
- [[1.3 Player Stats#Resting|Rest and recover]]
...
- **Prep your next move.** Know your options and resources ([[1.3 Player Stats#Health-and-Vitality|HP/Vitality]], [[6.1 Spells|spells]], items). Coordinate with allies for setups and defenses.
