...
- **Tier 1:** **Rot-Fist.** Your unarmed strikes deal 1d6 + STR mod Bludgeoning. On hit, target makes a CON save (DC 10 + Tier) or gains [[2.4 Conditions#Physical-Conditions|Diseased]] (end DC becomes 10 + Tier).
- **Tier 2:** **Dead Nerves.** Gain +5 to CON saving throws. Gain immunity to [[2.4 Conditions#Physical-Conditions|Poisoned]] and [[2.4 Conditions#Physical-Conditions|Diseased]].
- **Tier 3:** **Liquefy Wound.** Once per turn on a melee hit, add 1d8 Blight and inflict 1 stack of [[2.4 Conditions#Physical-Conditions|Bleeding]]. (No save)
- **Tier 4:** **Unliving Endurance.** Gain resistance to Necrotic, Poison, Toxin, and Blight damage.
- **Tier 5:** **Melt the Strong.** As an Action, one creature within 30 ft makes a CON save (DC 10 + CON mod + Tier). Fail: it gains [[2.4 Conditions#Physical-Conditions|Necrosis]] and -3 AC ([[2.4 Conditions#Physical-Conditions|Pierced]]) for 3 turns.
...
- **Tier 10:** **True Revenant.** Choose one:
    ...
    - **Melt Presence:** All enemies within 10 ft have -10 on saving throws vs [[2.4 Conditions#Physical-Conditions|Bleeding]], [[2.4 Conditions#Physical-Conditions|Diseased]], [[2.4 Conditions#Physical-Conditions|Necrosis]], [[2.4 Conditions#Physical-Conditions|Poisoned]] you apply.
## Ossid
...
- **Tier 1:** **Bone Blades.** Your unarmed strikes deal 1d6 + DEX mod Piercing. On hit, inflict 1 stack of [[2.4 Conditions#Physical-Conditions|Bleeding]]. (No save)
- **Tier 2:** **Open Artery.** Once per turn on a melee hit, add 1d8 Necrotic and inflict 1 additional stack of [[2.4 Conditions#Physical-Conditions|Bleeding]].
...
- **Tier 10:** **True Ossid.** Choose one:
    ...
    - **Bone Cage:** Gain +4 AC, and you are immune to [[2.4 Conditions#Physical-Conditions|Bleeding]], [[2.4 Conditions#Physical-Conditions|Poisoned]], [[2.4 Conditions#Physical-Conditions|Diseased]].
    - **Bloodstorm:** Once per turn, whenever you apply [[2.4 Conditions#Physical-Conditions|Bleeding]], apply +2 additional stacks.
## Shadowman
...
- **Tier 8:** **Blackout.** Once per combat as an Action, create a 30 ft radius blackout centered on you for 1 turn. Creatures inside are [[2.4 Conditions#Physical-Conditions|Blinded]] while inside.
...
- **Tier 8:** **Possession Thread.** As an Action, one creature within 30 ft of your bound object makes a WIS save (DC 10 + INT mod + Tier). Fail: it gains [[2.4 Conditions#Mental-Conditions|Mute]] and [[2.4 Conditions#Magical-Conditions|Slowed]] for 1 turn.
...
- **Tier 8:** **Terror Howl.** Once per combat as an Action, enemies within 20 ft make a WIS save (DC 10 + STR mod + Tier). Fail: [[2.4 Conditions#Mental-Conditions|Frightened]] and [[2.4 Conditions#Mental-Conditions|Demoralized]] for 1 turn.
...
- **Tier 10:** **True Lycanthrex.** Choose one:
    ...
    - **Pack Terror:** Your Terror Howl becomes 50 ft, and failed saves also apply [[2.4 Conditions#Physical-Conditions|Paralyzed]] for the remainder of that turn.
## Mycelari
...
- **Tier 10:** **True Mycelari.** Choose one:
    ...
    - **Living Colony:** Your Mushroom Thralls become 6  + (Racial Tier/3) thralls, and whenever a thrall hits, it also applies [[2.4 Conditions#Magical-Conditions|Slowed]] (1 turn, no save).