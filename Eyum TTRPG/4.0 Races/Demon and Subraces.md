...
###### Racial Abilities
- **Tier 1:** **Ironhide.** Gain +1 AC and you have advantage on constitution saving throws.
- **Tier 2:** **Magnet Grip.** Gain +3 to grapple checks and checks to resist grapples.
- **Tier 3:** **Plated Frame.** Reduce non-magical bludgeoning/piercing/slashing damage by 1 + Racial Tier.
- **Tier 4:** **Heat Sink.** Gain Resistance to Fire damage and lesser resistance to Slashing damage.
- **Tier 5:** **Steel Rush.** After you hit with a melee attack, you may move 10 ft without provoking reactions from that target. (Once per turn)
- **Tier 6:** **Reinforced Plates.** Gain +2 AC.
- **Tier 7:** **Deflecting Armor.** As a Rp, reduce damage from one hit by 1d10 + CON mod, half of that damage (rounded down) is reflected back on the attacker. 
- **Tier 8:** **Siege Body.** You count as one size larger than you are for everything other than fitting in spaces.
- **Tier 9:** **Adamant Core.** Your damage reduction reduces all damage types.
- **Tier 10:** **Living Warplate.** Choose one:
    - **Critical Guard:** Critical hits against you become normal hits (damage no longer bypasses vitality and doesn't deal max damage).
    - **Overheat Vent:** As a bonus action deal 2d8 Infernal to all creatures within 10 ft of you (DEX save (DC 20) halves).
    - **Iron Will:** Gain +5 to all saving throws and +2 to your WIS score. 
## Pyrrakin
