...
###### Racial Abilities
- **Tier 1:** **Irritant Touch.** Once per turn when you hit with a melee attack, add 1d4 Toxin damage.
- **Tier 2:** **Bright Glide.** Increase glide speed by +15 ft.
- **Tier 3:** **Flash Scales.** Once per combat as a Bonus Action, enemies within 10 ft must pass a CON save (DC 10 + CHA mod + Tier) or suffer -2 Accuracy until your next turn and take 1d12 radiant damage.
- **Tier 4:** **Aerial Grace.** Gain +1 AC while gliding.
- **Tier 5:** **Toxic Bloom.** Your Irritant Touch adds an additional 1d6 Toxin Damage.
...
- **Tier 10:** **Prismatic Apex.** Choose one:
    ...
    - **Sky Duelist:** Your glide speed becomes a fly speed and while flying you gain +5 Accuracy.
## Twigwrought
