...
- **Tier 10:** **Master Shapeshifter.** Choose one:
    - **War-Morph:** At the start of each of your turns, choose one until start of next turn: +3 AC, or +15 Base Melee Damage, or +15 Base Ranged Damage, or +15 Base Magic Damage.
...
- **Tier 4:** **Swamp Anchor.** Gain +2 AC and are immune to difficult terrain.
- **Tier 5:** **Pseudopod Weapons.** You gain a natural weapon formed from one of your limbs, this weapon does 3d8 Gel damage. 
- **Tier 6:** **Drown Grip.** You gain +10 to grapple checks. Creatures you grapple have -10 to escape checks.
- **Tier 7:** **Body Split.** Once per combat as an Action, split into two half-mass bodies. Each has your stats but half current HP and Vitality; both act on your turn. You can control them independently. If either hits 0 HP, it dissolves. If they both reach 0 hp you die. You can rejoin your halves as an Action merging HP and Vitality. Any conditions gained by either halves will be retained by the whole. 
- **Tier 8:** **Mire Flood.** As an Action, create a 20 ft radius mire centered on you. Enemies inside treat it as difficult terrain and take 2d10 Miasma at the start of their turns. (Concentration)
- **Tier 9:** **Goopy Gel.** All melee attacks gain +2d8 Gel damage. 
- **Tier 10:** **Apex Mireglopian.** Choose one:
    - **Colossal Slime:** Gain +50 Max HP, +3 AC, and Mire Regeneration becomes 4d10 + CON mod.
...
- **Tier 4:** **Radiant Mask.** Gain resistance to Radiant damage and +2 to all CHA-based checks.
...
- **Tier 4:** **Real Claws/Real Teeth.** Gain two natural attacks: Claws 1d8 + STR mod Slashing and Bite 1d10 + STR mod Piercing. When you make an attack with either you may make an attack with the other as part of that action. 
- **Tier 5:** **Seen It, Do It.** Once per short rest, after you see a creature use a spell or a skill you can also use that spell or skill for until you long rest again. Damage/Healing/Movement/Size from these skills and spells are halved.
- **Tier 6:** **Bone Shift Defense.** As a reaction when you are hit, reduce damage by 2d10 + CON mod.
- **Tier 7:** **Predatory Reconstruction.** If you reduce a creature to 0 HP, you immediately gain +3 AC and +10 Base Melee Damage until end of your next turn.
- **Tier 8:** **Perfect Anatomy Copy.** When you copy a humanoid, you also copy its Racial Tier abilities up to half of your own Racial Tier.
