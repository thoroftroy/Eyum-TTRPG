...
> For more information on Weapons and Armor see [[1.2.5 Weapons, Armors, and Materials]].
#### Critical Outcomes
...
## Attack Rolls
When making an attack, whether melee, ranged, or magical, you must roll an attack roll, which is compared to the target’s Armor Class (AC). If your total attack roll equals or exceeds their AC, the attack hits. For more information on Armor Class see [[1.1.3 Player Stats]].
