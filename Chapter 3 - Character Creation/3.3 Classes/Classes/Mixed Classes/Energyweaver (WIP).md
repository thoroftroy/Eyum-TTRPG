...
- **Basic Transfer (default action).** (see [[6.1.4 Energymancy (WIP)]] for more specifics)
...
- **Storage Capacity.** An object can only store so much energy in it. For more information see [[6.1.4 Energymancy (WIP)]].
