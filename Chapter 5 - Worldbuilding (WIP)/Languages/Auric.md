...
| Word (Auric)                | Pronunciation | POS       | Meaning / Definition       | Notes                     | Example (Auric; English)                                         |
| --------------------------- | ------------- | --------- | -------------------------- | ------------------------- | ---------------------------------------------------------------- |
| **ka**                      | KAH           | det/pron  | that (demonstrative)       | declines like adj.        | **ka saran-a ven-ta-e-a.** — “I saw that person.”                |
| **per**                     | PEHR          | prep      | by (agent)                 | for passives/agency       | **tel-ta-e-sha-u per telar-a.** — “It was told by the narrator.” |
| **ha**                      | HAH           | det/pron  | this (demonstrative)       | topic/demonstrative       | **ha elum-a mara.** — “This house is good.”                      |
| **cum**                     | KOOM          | prep      | with                       | —                         | **cum saran-in mor-a.** — “I go with the person.”                |
| **so**                      | SOH           | conj      | as, like (role)            | for “as X” uses           | **so telar-a an lar-a.** — “As a narrator, I speak.”             |
| **ram-**                    | RAHM          | v         | have/hold/possess          | Class B verb              | **an luma-en ram-a.** — “I have the light.”                      |
| **noya**                    | NOH-yah       | adj       | new                        | already in your set       | **ha elum-a noya.** — “This house is new.”                       |
| **Ø (grammar)**             | —             | —         | a / an (indefinite)        | Auric has **no article**  | **saran-a ven-a.** — “I see (a) person.”                         |
| **elum**                    | EH-loom       | n         | home, house                | existing noun             | **an elum-en ven-a.** — “I see the home.”                        |
| **rel**                     | REL           | prep      | about, concerning          | motionless topic          | **rel amar-os tel-a.** — “I speak about the temple.”             |
| **ram-**                    | RAHM          | v         | has (3sg of ‘have’)        | use **ram-u**             | **sar tor-en ram-u.** — “He has a stone.”                        |
| **tava**                    | TAH-vah       | adj       | free, unbound              | freedom sense             | **tava saran-a.** — “a free person.”                             |
| **kena**                    | KEH-nah       | adj       | other, another             | agrees in case/number     | **kena tor-en der-a.** — “I take the other stone.”               |
| **kar-**                    | KAHR          | v         | do, make                   | existing verb             | **an kar-a.** — “I do / make.”                                   |
| **ne**                      | NEH           | part      | no / not                   | preverbal negator         | **ne tor-en ven-a.** — “I see no stone.”                         |
| **zhora**                   | ZHOH-rah      | n         | time (general)             | new root                  | **zhora-in tel-a.** — “I speak in (about) time.”                 |
| **ur**                      | OOR           | adv/postp | up, upward                 | adverb or postposition    | **ur mor-a.** — “I go up.”                                       |
| **havash**                  | HAH-vash      | n         | news, tidings              | collective-friendly       | **havash-im bel-a.** — “I read the news.”                        |
| **ab**                      | AHB           | prep      | out of, from               | source/motion out         | **ab narum-in mor-ta-e-u.** — “He went out of the city.”         |
| **bol-**                    | BOHL          | v         | use, employ                | new Class B verb          | **an sitem-en bol-a.** — “I use the system.”                     |
| **ven-**                    | VEHn          | v         | see                        | existing verb             | **an tor-en ven-a.** — “I see the stone.”                        |
| **meru**                    | MEH-roo       | adv       | only, merely               | focus adverb              | **meru an tel-a.** — “Only I speak.”                             |
| **trad-eth**                | TRAHD-ehth    | n         | business, trade (activity) | abstract from **trad**    | **trad-eth-en kar-a.** — “I do business.”                        |
| **shavar**                  | SHAH-var      | n         | web, net (digital/web)     | also literal “web”        | **shavar-in-ko del-a.** — “I write on the web.”                  |
| **eta**                     | EH-tah        | adv       | also, too                  | discourse adverb          | **eta an mor-a.** — “I also go.”                                 |
| **ves-eth**                 | VEH-sehth     | n         | help, assistance           | from verb **ves-** “help” | **ves-eth-en ten-a.** — “I give help.”                           |
| **der-**                    | DEHR          | v         | get, obtain, take          | existing verb             | **an ves-eth-en der-a.** — “I get the help.”                     |
| **vesper**                  | VEH-sper      | adv/n     | evening; “PM”              | time word                 | **vesper an mor-a.** — “I go in the evening (PM).”               |
| **lor-**                    | LOHR          | v         | look (at), view            | existing                  | **an tor-en lor-a.** — “I look at the stone.”                    |
| **(phrase)** _shavar-in-ko_ | —             | adv       | online (locative phrase)   | ‘at the web’              | **an shavar-in-ko del-a.** — “I write online.”                   |
| **an-ith**                  | AHN-ith       | adj       | first (ordinal)            | ordinal pattern           | **an-ith mer-a.** — “the first day.”                             |
| **ves-eth** (pl.)           | —             | n         | services                   | plural **-im**            | **ves-eth-im plan-a.** — “(We) plan the services.”               |
| **ha-im**                   | HAH-im        | det/pron  | these                      | plural of **ha**          | **ha-im tor-im…** — “these stones…”                              |
| **ril-**                    | REEL          | v         | like, be fond of           | new Class B verb          | **an amel-en ril-a.** — “I like bread.”                          |
| **fen-**                    | FEHN          | v         | find                       | existing                  | **an fen-a.** — “I find.”                                        |
| **kes**                     | KEHS          | n         | price, cost                | new noun (coda **-s**)    | **kes-en ask-a.** — “I ask the price.”                           |
| **heda**                    | HEH-dah       | n         | date (calendar day)        | new noun                  | **heda-en del-a.** — “I write the date.”                         |
| **haru**                    | HAH-roo       | n         | back, rear                 | location/body sense       | **haru-in-ko sed-na-a.** — “I am at the back.”                   |
| **keln**                    | KEHLN         | n         | top, summit                | coda **-n** allowed       | **keln-en ven-a.** — “I see the top.”                            |
| **ram-**                    | RAHM          | v         | had (PST of ‘have’)        | use **ram-ta-e-**         | **an tor-en ram-ta-e-a.** — “I had a stone.”                     |
| **rekel**                   | REH-kel       | n         | list, register             | new noun                  | **rekel-en bel-a.** — “I read the list.”                         |
| **sekar**                   | SEH-kar       | n         | name                       | new noun                  | **sekar-en ask-a.** — “I ask the name.”                          |
| **suke**                    | SOO-keh       | adv       | just, exactly              | discourse adverb          | **suke, an mor-a.** — “Exactly, I go.”                           |
| **hiran**                   | HEE-ran       | n         | state, condition           | sense 1 (condition)       | **hiran-en tel-a.** — “I state/describe the condition.”          |
| **ragon**                   | RAH-gon       | n         | state (political region)   | sense 2 (polity)          | **ragon-en ven-a.** — “I see the state.”                         |
| **mer**                     | MAIR          | n         | day                        | existing                  | **mer-in sed-na-a.** — “I am here in the day.”                   |
| **iskel**                   | EES-kel       | n         | health, well-being         | new noun                  | **iskel-en care-a.** — “I care for health.”                      |
| **iterun**                  | EE-teh-roon   | adv       | again, re-                 | already defined           | **iterun kar-ta-e-u.** — “He rebuilt (did again).”               |
| **selka**                   | SEHL-kah      | adj       | next, following            | agrees in case/number     | **selka mer-a.** — “the next day.”                               |
