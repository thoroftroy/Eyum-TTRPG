...
### Other Words
Words I needed but haven't sorted yet, this list will continue expanding for a while
...
| **of**            | —               | case use | GEN case (no separate word)               | documenting usage (§3.1, §5.6)                             | **mundum-os…** — “of the world.”                                           |
| **is / be / are** | —               | verb use | zero copula in present; **es-** otherwise | per §4.7                                                   | **heru-a mara.** — “The hero is good.” / **es-e-u…**                       |
| **the**           | —               | det use  | no article; use **ha/ka** as needed       | per §3.3, §3.2                                             | **ha ludum-a…** — “this game…”                                             |
